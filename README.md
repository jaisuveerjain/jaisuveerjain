...
**🇳🇬 Nigeria (Project Deployment):** On-ground deployment for MTN's digital transformation  
**🇩🇪 Germany (2024-Present):** Expanding horizons with AI/ML studies and seeking new DevOps challenges

### 🛠️ My Tech Arsenal

```
☁️  AWS | Terraform | Docker | Kubernetes | Jenkins
🐧  Linux | Python | Bash | Git | Helm | Maven
📊  Grafana | Tableau | Power BI | LookerStudio
🤖  Machine Learning | NLP | LLMs | Generative AI
📈  Big Data Processing | Data Analytics | Visualization
...
- 👥 Socially engaging with a food lovers community with 70k followers 
